resource "aws_cloudfront_distribution" "this" {
        ...
        content {
          dynamic "cookies" {
            ...
            content {
              ...
              whitelisted_names = length(cookies.value.whitelisted_names) == 0 ? null : cookies.value.whitelisted_names
            }
          }
          headers                 = length(forwarded_values.value.headers) == 0 ? null : forwarded_values.value.headers
          query_string            = forwarded_values.value.query_string
          query_string_cache_keys = length(forwarded_values.value.query_string_cache_keys) == 0 ? null : forwarded_values.value.query_string_cache_keys
        }
      }
  ...
  dynamic "ordered_cache_behavior" {
    ...
    content {
      ...
      dynamic "grpc_config" {
        for_each = ordered_cache_behavior.value.grpc_config
        content {
          enabled = grpc_config.value.enabled
        }
      }
  ...
  dynamic "origin" {
    ...
    content {
      ...
      origin_access_control_id = length(origin.value.origin_access_control_id) == 0 ? null : origin.value.origin_access_control_id
  ...
  dynamic "viewer_certificate" {
    ...
    content {
      ...
      minimum_protocol_version       = viewer_certificate.value.cloudfront_default_certificate != false ? null : viewer_certificate.value.minimum_protocol_version
      ssl_support_method             = viewer_certificate.value.cloudfront_default_certificate ? null : viewer_certificate.value.ssl_support_method
      acm_certificate_arn            = viewer_certificate.value.cloudfront_default_certificate ? null : viewer_certificate.value.acm_certificate_arn
      iam_certificate_id             = viewer_certificate.value.cloudfront_default_certificate ? null : viewer_certificate.value.acm_certificate_arn != null ? null : viewer_certificate.value.iam_certificate_id
    }
  }
