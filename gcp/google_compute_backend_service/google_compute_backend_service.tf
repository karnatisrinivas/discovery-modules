resource "google_compute_backend_service" "this" {
  ...
  dynamic "locality_lb_policies" {
    ...
    content {
      dynamic "custom_policy" {
        for_each = locality_lb_policies.value.custom_policy
        content {
      ...
      dynamic "policy" {
        for_each = locality_lb_policies.value.policy
        content {
  ...
  dynamic "security_settings" {
    ...
    content {
      ...
      dynamic "aws_v4_authentication" {
        for_each = security_settings.value.aws_v4_authentication
        content {
  ...
  dynamic "strong_session_affinity_cookie" {
    ...
    content {
      ...
      dynamic "ttl" {
        for_each = strong_session_affinity_cookie.value.ttl
        content {
          nanos   = ttl.value.nanos
          seconds = ttl.value.seconds
        }
