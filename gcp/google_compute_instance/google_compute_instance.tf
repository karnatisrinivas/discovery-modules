resource "google_compute_instance" "this" {
  ...
  dynamic "boot_disk" {
    ...
    content {
      ...
      disk_encryption_key_raw = boot_disk.value.disk_encryption_key_raw == "" ? null : boot_disk.value.disk_encryption_key_raw
      interface               = boot_disk.value.interface == "" ? null : boot_disk.value.interface
      kms_key_self_link       = boot_disk.value.kms_key_self_link == "" ? null : boot_disk.value.kms_key_self_link
  ...
  dynamic "network_interface" {
    ...
    content {
      ...
      nic_type                    = network_interface.value.nic_type == "" ? null : network_interface.value.nic_type
