resource "google_compute_instance_template" "this" {
  ...
  dynamic "disk" {
    ...
    content {
      ...
      resource_manager_tags  = disk.value.resource_manager_tags
      ...
      dynamic "source_image_encryption_key" {
        for_each = disk.value.source_image_encryption_key
        content {
      ...
      dynamic "source_snapshot_encryption_key" {
        for_each = disk.value.source_snapshot_encryption_key
        content {
