resource "google_compute_url_map" "this" {
  ...
  dynamic "default_route_action" {
    for_each = var.default_route_action != null ? var.default_route_action : []
    content {
      dynamic "cors_policy" {
      ...
      dynamic "max_stream_duration" {
        for_each = default_route_action.value.max_stream_duration
        content {
  ...
  dynamic "default_url_redirect" {
    for_each = var.default_url_redirect != null ? var.default_url_redirect : []
    content {
        ...
        content {
          ...
          dynamic "route_action" {
            ...
            content {
              ...
              dynamic "max_stream_duration" {
                for_each = route_action.value.max_stream_duration
                content {
                  nanos   = max_stream_duration.value.nanos
                  seconds = max_stream_duration.value.seconds
                }
